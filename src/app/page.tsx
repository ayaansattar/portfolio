      ...
      <div className="relative z-10 flex min-h-full flex-col">
        ...
        >
          ...
          <div className="relative z-10 flex min-h-svh flex-col pointer-events-none">
            <main
              className="pointer-events-auto relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col items-start justify-center px-6 pb-16 pt-10 text-left max-md:items-center max-md:justify-end max-md:pb-14 max-md:pt-[62%] max-md:text-center sm:px-10 md:pt-8"
            >
              ...
              <div className="animate-rise-delay-3 mt-10 flex flex-wrap items-center justify-start gap-4 max-md:justify-center">
                <a
                  href={RESUME_URL}
                  target="_blank"
